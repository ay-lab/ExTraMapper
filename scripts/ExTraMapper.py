...
def dynamic_programming_per_transcriptPair(t1,t2):
...
def all_exonPairs_per_transcriptPair(t1,t2):

	elist1=transcriptDic1[t1].exons
	elist2=transcriptDic2[t2].exons
	ecodinglist1=transcriptDic1[t1].codingExons
	ecodinglist2=transcriptDic2[t2].codingExons
